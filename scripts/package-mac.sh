...
# cm-server / arxiv-mcp 五个产物到 build/，再用 electron-builder 打成可拖到 Applications 的 dmg。
...
echo "════════════════════════════════════════"
echo " [4/6] 构建 cm-server（PyInstaller）"
echo "════════════════════════════════════════"
bash "$ROOT_DIR/scripts/build-cm-server.sh"

echo "════════════════════════════════════════"
echo " [5/6] 构建 arxiv-mcp（PyInstaller，打入安装包，不再依赖容器内 arxiv-mcp 主机名）"
echo "════════════════════════════════════════"
