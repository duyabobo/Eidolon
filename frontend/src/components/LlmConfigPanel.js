...
export default function LlmConfigPanel() {
    ...
    return (_jsxs(ConfigPanelLayout, { loading: loading, loadingText: "\u52A0\u8F7D LLM \u914D\u7F6E\u2026", errMsg: errMsg, toolbar: (_jsx(ConfigListToolbar, { left: _jsx("p", { className: "text-xs text-ink-500", children: "\u9009\u62E9\u5F53\u524D\u751F\u6548\u7684 LLM \u914D\u7F6E\uFF08\u5355\u9009\uFF09" }), right: _jsx(ConfigPrimaryBtn, { onClick: openCreate, children: "+ \u6DFB\u52A0" }) })), children: [profiles.length === 0 ? (_jsx(ConfigEmptyState, { message: "\u6682\u65E0 LLM \u914D\u7F6E\uFF0C\u70B9\u51FB\u300C\u6DFB\u52A0\u300D\u521B\u5EFA" })) : (_jsx("div", { className: "space-y-2", children: profiles.map((profile) => (_jsx(ConfigListItem, { highlighted: activeId === profile.id, leading: (_jsx("input", { type: "radio", name: "llm-profile", checked: activeId === profile.id, onChange: () => void handleSelect(profile.id), className: "accent-brand-600 mt-1" })), title: profile.name, subtitle: `${profile.protocol} · ${profile.model} · ${profile.base_url}`, actions: (_jsxs(_Fragment, { children: [_jsx(ConfigActionBtn, { onClick: () => openEdit(profile), children: "\u7F16\u8F91" }), _jsx(ConfigActionBtn, { variant: "danger", disabled: profiles.length <= 1, onClick: () => void handleDelete(profile), children: "\u5220\u9664" })] })) }, profile.id))) })), modal && (_jsx(LlmProfileModal, { modal: modal, saving: saving, onChange: (form) => setModal({ ...modal, form }), onSave: () => void handleModalSave(), onCancel: () => setModal(null) }))] }));
}
