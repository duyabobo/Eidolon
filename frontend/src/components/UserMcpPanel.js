...
function Section({ title, items, badge, badgeCls, onDelete, }) {
    return (_jsxs("div", { children: [_jsx("h3", { className: "text-sm font-medium text-ink-700 mb-2", children: title }), items.length === 0 ? (_jsx("p", { className: "text-xs text-ink-400", children: "\u6682\u65E0" })) : (_jsx("div", { className: "space-y-2", children: items.map((s) => (_jsxs("div", { className: "flex items-center gap-2 border border-ink-200/60 rounded-xl px-3 py-2.5", children: [_jsx("span", { className: `text-[10px] px-1.5 py-0.5 rounded-full font-medium ${badgeCls}`, children: badge }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-medium truncate text-ink-800", children: s.name }), _jsx("p", { className: "text-xs text-ink-400 truncate", children: s.description || s.url }), s.has_api_key && _jsx("p", { className: "text-[10px] text-amber-700 mt-0.5", children: "\u5DF2\u914D\u7F6E API Key" })] }), onDelete && (_jsx("button", { type: "button", onClick: () => onDelete(s.name), className: "text-xs text-rose-500 shrink-0 hover:text-rose-700", children: "\u5220\u9664" }))] }, `${s.scope}-${s.name}`))) }))] }));
}
