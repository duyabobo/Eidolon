...
from cm_server.admin.constants.knowledge import KNOWLEDGE_KEY_HEADER, SCENE_UID_HEADER
...
from cm_server.admin.routes.knowledge_deps import require_knowledge_key, require_scene_uid
from cm_server.admin.services import knowledge_client, knowledge_config_store
...
from cm_server.admin.services.knowledge_store import document_file_path, get_base as local_get_base
...
async def api_upload_document(
    ...
    return await local_upload_document(kb_id, file)
